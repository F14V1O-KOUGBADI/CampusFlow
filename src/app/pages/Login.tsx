...
import { Mail, Lock, Eye, EyeOff, AlertCircle, X, Sun, Moon } from "lucide-react";
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      setError(loginError || "Identifiants invalides. Veuillez réessayer.");
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative">
      <div className="absolute top-6 right-6">
        <button 
          onClick={toggleTheme}
          className="p-3 bg-surface border border-border rounded-2xl text-text-secondary hover:text-primary transition-all shadow-soft"
        >
